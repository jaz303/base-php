...
function base_php_autoloader($class) {
    ...
    static $map = array (
      ...
      'NoSuchMethodException' => 'base.php',
      'SecurityException' => 'base.php',
      'SyntaxException' => 'base.php',
      'Persistable' => 'base.php',
      'Callback' => 'base.php',
      ...
      'Date_Time' => 'date.php',
      'Errors' => 'errors.php',
      'AbstractFile' => 'file.php',
      'File' => 'file.php',
      'UploadedFile' => 'file.php',
      'UploadedFileError' => 'file.php',
      'UnsupportedImageTypeException' => 'image.php',
      'Image' => 'image.php',
      'MIME' => 'mime.php',
      ...
      'GDBQuery' => 'gdb/gdb.php',
      'GDBQueryJoin' => 'gdb/gdb.php',
