...
abstract class Test_Reporter
{
	...
	public function test_enter(Test_Invoker $invoker) {
		$this->test_total++;
		$this->report_test_enter($invoker);
	}
	
	public function test_exit(Test_Invoker $invoker) {
	...
	public function test_fail(Error_AssertionFailed $eaf) {
		$this->incidents[] = $eaf;
		$this->test_failures++;
	...
	protected function report_test_enter(Test_Invoker $invoker) {}
	protected function report_test_exit(Test_Invoker $invoker) {}

	protected function report_test_pass() {}
	protected function report_test_fail(Error_AssertionFailed $eaf) {}
