...
class MIME
{
    ...
    public static function for_file($file, $default = null) {
        if ($file instanceof File) $file = $file->path();
        // TODO: use system functions if possible
        return self::for_filename(basename($file), $default);
    }
    ...
    public static function for_extension($extension, $default = null) {
